  ...
  return (
    <div className="fixed bottom-2 right-2 z-50 font-sans flex flex-col items-end bg-transparent">
      ...
      {!isOpen && showGreetingBubble && (
        <div className="mb-2 mr-1 bg-[#11192e] text-white border border-lime-500/40 shadow-[0_0_20px_rgba(132,204,22,0.2)] rounded-2xl px-4 py-2.5 flex items-center space-x-3 animate-in fade-in slide-in-from-bottom-2 duration-300 relative cursor-pointer">
          <div onClick={() => {
            setIsOpen(true);
            setShowGreetingBubble(false);
            if (hasSubmittedLead) {
          ...
          <div className="absolute -bottom-1.5 right-6 w-3 h-3 bg-[#11192e] border-r border-b border-lime-500/40 rotate-45" />
        </div>
      )}
      ...
      {isOpen && (
        <div className="w-[350px] sm:w-[380px] h-[520px] bg-[#0d1322] border border-gray-800 rounded-2xl shadow-2xl flex flex-col overflow-hidden backdrop-blur-2xl animate-in fade-in slide-in-from-bottom-4 duration-200 relative">
          ...
          {/* Header */}
          <div className="p-3 px-4 bg-gradient-to-r from-lime-950/40 via-[#11192e] to-[#11192e] border-b border-gray-800 flex items-center justify-between">
            <div className="flex items-center space-x-2.5">
              ...
              <div>
                ...
                <div className="flex items-center space-x-1.5 text-[10px] text-lime-400">
          ...
          {!hasSubmittedLead ? (
            ...
            <div className="flex-1 p-6 flex flex-col justify-center bg-[#0a0f1c] text-white">
              <div className="text-center mb-5">
                <div className="w-12 h-12 rounded-2xl bg-lime-500/15 border border-lime-500/30 flex items-center justify-center mx-auto mb-3 text-lime-400 shadow-[0_0_15px_rgba(132,204,22,0.15)]">
              ...
              <form onSubmit={handleLeadSubmit} className="space-y-3.5">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#131b2e] border border-gray-700 rounded-xl pl-9 pr-3.5 py-2 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-lime-500 focus:ring-1 focus:ring-lime-500/40 transition-all"
                    />
                  </div>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full py-2.5 px-4 rounded-xl bg-lime-500 hover:bg-lime-400 text-black text-xs font-bold transition-all shadow-[0_0_15px_rgba(132,204,22,0.3)] flex items-center justify-center space-x-2 mt-2 cursor-pointer"
                >
            ...
            <div className="flex-1 bg-[#0a0f1c] text-white flex flex-col justify-between overflow-hidden">
              ...
              <div className="p-3 border-t border-gray-800 bg-[#11192e]">
                <button
                  onClick={handleStartNewChat}
                  className="w-full py-2.5 px-4 rounded-xl bg-lime-500 hover:bg-lime-400 text-black text-xs font-bold transition-all shadow-[0_0_15px_rgba(132,204,22,0.3)] flex items-center justify-between group cursor-pointer"
                >
            ...
            <>
              ...
              >
                {messages.map((m) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className={"max-w-[85%] rounded-2xl px-3.5 py-2 text-xs leading-relaxed shadow-sm " + (isVisitor ? "bg-lime-500 text-black font-medium rounded-br-none" : "bg-[#131b2e] border border-gray-800 text-gray-100 rounded-bl-none")}
                      >
                        {m.content}
                        <div className={`flex items-center space-x-1 mt-1 ${isVisitor ? 'justify-end text-black/60' : 'justify-start text-gray-400'}`}>
                ...
                {agentTypingText && (
                  <div className="flex items-center space-x-2 text-[11px] text-lime-400 bg-lime-950/40 border border-lime-800/40 rounded-xl px-3 py-2 animate-pulse">
                    <div className="flex space-x-1 items-center">
                      <span className="w-1.5 h-1.5 rounded-full bg-lime-400 animate-bounce" />
                      <span className="w-1.5 h-1.5 rounded-full bg-lime-400 animate-bounce delay-100" />
                      <span className="w-1.5 h-1.5 rounded-full bg-lime-400 animate-bounce delay-200" />
                    </div>
                    <span className="font-medium text-lime-300">Real Agent is typing...</span>
                  </div>
                )}

                {loading && (
                  <div className="flex items-center space-x-1.5 text-[11px] text-gray-400 p-1">
                    <span className="w-1.5 h-1.5 rounded-full bg-lime-500 animate-bounce" />
                    <span className="w-1.5 h-1.5 rounded-full bg-lime-500 animate-bounce delay-100" />
                    <span className="w-1.5 h-1.5 rounded-full bg-lime-500 animate-bounce delay-200" />
                    <span>Typing...</span>
                  </div>
                )}
              ...
              <form onSubmit={handleSend} className="p-2.5 border-t border-gray-800 bg-[#11192e] flex items-end space-x-2">
                <textarea
                  ...
                  className="flex-1 bg-[#131b2e] border border-gray-700 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-gray-400 focus:outline-none focus:border-lime-500 focus:ring-1 focus:ring-lime-500/40 resize-none overflow-y-auto whitespace-pre-wrap break-words leading-relaxed transition-[height] duration-75"
                  style={{ minHeight: '38px', maxHeight: '130px' }}
                />
                <button
                  type="submit"
                  disabled={loading || !inputText.trim()}
                  className="p-2.5 rounded-xl bg-lime-500 text-black hover:bg-lime-400 transition-all disabled:opacity-40 flex-shrink-0 mb-0.5 shadow-[0_0_15px_rgba(132,204,22,0.3)] cursor-pointer font-bold"
                >
