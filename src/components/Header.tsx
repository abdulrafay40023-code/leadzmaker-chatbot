          ...
          <div className="flex items-center space-x-3 pl-3 border-l border-dark-border">
            ...
            <div className="text-left hidden sm:block">
              <div className="flex items-center space-x-1.5">
                ...
                {(currentAgent.role === 'admin' || ['abdulrafay40023@gmail.com', 'support@leadzmaker.com', 'garryamelia6265@gmail.com', 'tzafar04@gmail.com', 'annusraees@gmail.com'].includes(currentAgent.email?.toLowerCase() || '')) && (
